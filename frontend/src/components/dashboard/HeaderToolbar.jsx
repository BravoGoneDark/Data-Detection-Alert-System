      ...
      <div>
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs px-2.5 py-0.5 rounded-full border border-amber-500/40 bg-amber-950/40 text-amber-300 font-mono">
            Stage 11: Statistical & Behavioral Anomaly Defense
          </span>
        </div>
        <p className="text-slate-400 text-sm mt-1">
          Secure Data Download Duplication, Compliance Ledger & Behavioral Anomaly Detection System
        </p>
      </div>
